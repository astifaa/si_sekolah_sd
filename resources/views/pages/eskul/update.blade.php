...
<!-- end breadcrumb -->
<!-- begin page-header -->
<h1 class="page-header">Ubah eskul <small></small></h1>
<!-- end page-header -->

<!-- begin panel -->
<div class="panel panel-inverse">
	<div class="panel-heading">
		<h4 class="panel-title">Ubah eskul</h4>
	</div>
	<div class="panel-body">
	<form class="form-horizontal" method="POST" action="{{ url('eskul/update', $data['id_informasi']) }}" enctype="multipart/form-data">
            @csrf
			<div class="card-body">
				...
				<div class="form-group" style="float:right;">
					...
					<a href="{{ url('eskul/index/') }}" class="btn btn-white" data-dismiss="modal">Kembali</a>
				</div>
			</form>
		</div>
	</div>
