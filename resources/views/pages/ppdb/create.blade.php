...
<!-- end breadcrumb -->
<!-- begin page-header -->
<h1 class="page-header">Form Tambah ppdb <small></small></h1>
<!-- end page-header -->

<!-- begin panel -->
<div class="panel panel-inverse">
	<div class="panel-heading">
		<h4 class="panel-title">Tambah ppdb</h4>
	</div>
	<div class="panel-body">
	<form class="form-horizontal" method="POST" action="{{ url('ppdb/save') }}" enctype="multipart/form-data">
            @csrf
			<div class="card-body">                 
