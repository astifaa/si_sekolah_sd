		...
		<form class="form-horizontal" enctype="multipart/form-data">
			...
			<div class="card-body">
				...
				<div class="form-group">
					...
					<textarea class="textarea form-control bg-white" style="border: none;" id="wysihtml5" name="deskripsi" placeholder="Enter text ..." rows="12" disabled>{{ $data['deskripsi'] }}</textarea>
				</div>
