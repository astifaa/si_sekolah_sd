...
<!-- end breadcrumb -->
<!-- begin page-header -->
<h1 class="page-header">Ubah galeri <small></small></h1>
<!-- end page-header -->

<!-- begin panel -->
<div class="panel panel-inverse">
	<div class="panel-heading">
		<h4 class="panel-title">Ubah galeri</h4>
	</div>
	<div class="panel-body">
	<form class="form-horizontal" method="POST" action="{{ url('galeri/update', $data['id_informasi']) }}" enctype="multipart/form-data">
            @csrf
			<div class="card-body">
