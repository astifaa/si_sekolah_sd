...
<!-- end breadcrumb -->
<!-- begin page-header -->
<h1 class="page-header">Ubah Fasilitas <small></small></h1>
<!-- end page-header -->

<!-- begin panel -->
<div class="panel panel-inverse">
	<div class="panel-heading">
		<h4 class="panel-title">Ubah Fasilitas</h4>
	</div>
	<div class="panel-body">
	<form class="form-horizontal" method="POST" action="{{ url('fasilitas/update', $data['id_informasi']) }}" enctype="multipart/form-data">
            @csrf
			<div class="card-body">
				...
				<div class="form-group" style="float:right;">
					...
					<a href="{{ url('fasilitas/index/') }}" class="btn btn-white" data-dismiss="modal">Kembali</a>
				</div>
			</form>
		</div>
	</div>
