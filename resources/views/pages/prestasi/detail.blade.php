...
<!-- end breadcrumb -->
<!-- begin page-header -->
<h1 class="page-header">Detail prestasi <small></small></h1>
<!-- end page-header -->

<!-- begin panel -->
<div class="panel panel-inverse">
	<div class="panel-heading">
		<h4 class="panel-title">Detail prestasi</h4>
	</div>
		...
		<form class="form-horizontal" enctype="multipart/form-data">
			...
			<div class="card-body">
				...
				<div class="form-group">
					...
					<textarea class="textarea form-control bg-white" style="border: none;" name="deskripsi" placeholder="Enter text ..." rows="12" disabled>{{ $data['deskripsi'] }}</textarea>
				</div>
