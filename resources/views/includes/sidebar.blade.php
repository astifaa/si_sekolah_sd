...
@endphp
<!-- begin #sidebar -->
<div id="sidebar" style="background-color: #17479a" class="sidebar {{ $sidebarClass }}">
	...
	<div data-scrollbar="true" data-height="100%">
        ...
        <input type="text" class="form-control" placeholder="Sidebar menu filter..." data-sidebar-search="true" />
			...
			@endif
			<li class="nav-header">Menu Kelola Data</li>
			@php
				...
				foreach (config('sidebar.menu') as $key => $menu) {
					...
					$hasLabel = (!empty($menu['label'])) ? '<span style="background-color: aqua;" class="label label-theme m-l-5">'. $menu['label'] .'</span>' : '';
