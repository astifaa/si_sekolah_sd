 ...
 <section id="hero">
    ...
    <div class="testimonials-slider swiper-container" data-aos="fade-up" data-aos-delay="100">
          <div class="swiper-wrapper">
            ...
            <div class="carousel-item active" style="background-image: url('https://unsplash.it/320/240?image=20');">
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          ...
          <div class="col-lg-12 pt-4 pt-lg-0 content d-flex flex-column text-center" data-aos="fade-up" data-aos-delay="100">
            ...
            <a href="/about" class=" btn btn-primary btn-lg">Selengkapnya</a>
            <!--<ul>
              <li>
        ...
        <div class="row mx-auto my-auto">
          ...
          <div id="recipeCarousel2" class="carousel slide " data-bs-ride="carousel">
            ...
            <?php }else{ ?>
              ...
              <a class="carousel-control-prev w-auto" data-bs-target="#recipeCarousel2" role="button" data-bs-slide="prev">
                  <span class="carousel-control-prev-icon bg-dark border border-dark rounded-circle" aria-hidden="true"></span>
                  <span class="sr-only">Previous</span>
              </a>
              <a class="carousel-control-next w-auto" data-bs-target="#recipeCarousel2" role="button" data-bs-slide="next">
                  <span class="carousel-control-next-icon bg-dark border border-dark rounded-circle" aria-hidden="true"></span>
                  <span class="sr-only">Next</span>
              </a>
            </div>
