...
class EskulController extends Controller
{
    ...
    {
        $data = Informasi_Sekolah::getListDataEskul();
        return view('pages.eskul.index')
        ->with('data', $data);
    }
    ...
    public function show($id)
    {
        ...
        return view('pages.eskul.detail')
        ->with('data', $data);
    }
    ...
    {
        $data = Informasi_Sekolah::find($id);
        return view('pages.eskul.update')
        ->with('data', $data);
    }
